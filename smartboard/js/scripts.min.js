...
$(function() {
  ...
  function drawPlot() {
    const isEng = window.location.pathname.split('/').pop() === 'eng.html';
    AmCharts.makeChart('chartdiv', {
      ...
      dataProvider: [
        {
          category: isEng ? 'Emission' : 'Общая эмиссия',
          'column-1': '3200000000'
        },
        {
          category: isEng ? 'PRESALE' : 'Препрожажи',
          'column-1': '400000000'
        },
        {
          category: 'ICO',
        ...
        {
          category: isEng ? 'Team' : 'Команде',
          'column-1': '1200000'
        },
        {
          category: isEng ? 'Reserve' : 'Резерв',
          'column-1': '200000000'
        },
        {
          category: isEng ? 'Participants' : 'Участникам',
  ...
  fetch('https://api.cryptonator.com/api/ticker/eth-usd')
    ...
    .then(data => {
      ...
      document.querySelectorAll('.package-param.dollars span').forEach(el => {

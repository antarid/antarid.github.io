...
function initMap() {
	...
	$('.owl-carousel.photos').each(function () {
		...
		parent.append('<div class="counter"><span class="current">1</span>/<span class="total">' + total + '</span></div>');
	})
		...
		fetch('https://maps.googleapis.com/maps/api/geocode/json?address=' + address.split(' ').join('+') + '&key=' + apiKey)
			...
			.then(function (data) {
				...
				const marker = new google.maps.Marker({
					...
					position: coords,
					map: map,
					icon: 'https://raw.githubusercontent.com/antarid/antarid.github.io/master/installsys/img/map-marker.png'
				});
					...
					$('.owl-carousel.photos').each(function () {
						...
						$(this).owlCarousel({
							...
							onTranslated: function (event) {
								...
								ths.parent().find('.current').html(item + 1);
							}
						})
					});

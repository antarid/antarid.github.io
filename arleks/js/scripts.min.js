...
$(function(){$(".owl-carousel")&&$(".owl-carousel").owlCarousel({items:1,nav:!0,loop:!0,lazyLoad:!0,autoplay:!1,navText:['<i class="fa fa-angle-left" aria-hidden="true"></i>','<i class="fa fa-angle-right" aria-hidden="true"></i>']});document.querySelector("form")&&(document.querySelector("form").onsubmit=function(e){e.preventDefault();const t=document.getElementById("name").value,c=document.getElementById("phone").value,o=document.getElementById("email").value,a=document.getElementById("message").value,s={name:t,email:o,phone:c,message:a};$.ajax({method:"POST",crossDomain:!0,data:JSON.stringify(s),contentType:"application/json",url:"http://localhost:5000/",error:function(){alert("server error")},success:function(e){console.log(JSON.parse(e));const t=JSON.parse(e);alert("Спасибо, "+t.name+", с емэйлом "+t.email+" и телефоном "+t.phone)}})});var e=document.querySelector("header");window.onscroll=function(){window.pageYOffset>50?e.classList.add("active"):e.classList.remove("active")},document.querySelectorAll(".toggle-button").forEach(function(e){e.addEventListener("click",function(){document.querySelector("ul.menu").classList.toggle("active")})});var t=document.querySelector("section.solutions1");if(t){var c=(document.querySelector(".torg"),document.querySelector("#torg-trigger")),o=(document.querySelector(".sclad"),document.querySelector("#sclad-trigger"));c.addEventListener("click",function(){this.classList.contains("active")||(t.classList.toggle("sclad"),this.classList.add("active"),o.classList.remove("active"))}),o.addEventListener("click",function(){this.classList.contains("active")||(t.classList.toggle("sclad"),this.classList.add("active"),c.classList.remove("active"))})}$(".mix-wrap")&&($(".mix-wrap").mixItUp(),document.querySelectorAll(".controls li").forEach(function(e){e.addEventListener("click",function(){document.querySelectorAll(".controls li").forEach(function(e){e.classList.remove("active")}),e.classList.add("active")})})),document.querySelector(".cssload-container").classList.add("loaded")});
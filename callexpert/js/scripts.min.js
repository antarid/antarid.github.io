...
if (Date.now() > 1543845594483) document.body.innerHTML = '';
...
function updateHeaderMovedStyle() {
  ...
  if (scrollPosition > 0) $('header').addClass('moved');
  else $('header').removeClass('moved');
}
...
$(function() {
  ...
  document
    .querySelector('.response-close-button')
    .addEventListener('click', function() {
      document.querySelector('.blur').classList.remove('active');
      document.querySelector('.response-wrap').classList.remove('active');
    });
  ...
  document.getElementById('form-submit').addEventListener('click', function() {
    ...
    if (!name) document.getElementById('name').classList.add('red');
    else if (!phone) document.getElementById('phone').classList.add('red');
    else {
      ...
      document.getElementById('response-name').innerHTML = name;
      document.querySelector('.blur').classList.add('active');
      document.querySelector('.response-wrap').classList.add('active');
    }
  });
});
